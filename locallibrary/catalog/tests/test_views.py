...
class LoanedBookInstancesByUserListViewTest(TestCase):
    ...
    def test_only_borrowed_books_in_list(self):
        ...
        #Checking that we initially do not have books in the list
        ...
        #Checking that all reserved books are on the list
        resp = self.client.get(reverse('my-borrowed'))
        #Checking that the user is logged in
        self.assertEqual(str(resp.context['user']), 'testuser1')
        #Verifying the success of the response
        self.assertEqual(resp.status_code, 200)
    ...
    def test_pages_ordered_by_due_date(self):
        ...
        #Confirmation that only 10 instances are shown from the entire list
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def setUp(self):
        ...
        #Creating a genre Create genre as a post-step
        genre_objects_for_book = Genre.objects.all()
        test_book.genre=genre_objects_for_book
        test_book.save()

        #Create a BookInstance object for the user test_user1
        return_date= datetime.date.today() + datetime.timedelta(days=5)
        self.test_bookinstance1=BookInstance.objects.create(book=test_book,imprint='Unlikely Imprint, 2016', due_back=return_date, borrower=test_user1, status='o')

        #Create a BookInstance object for the user test_user2
        return_date= datetime.date.today() + datetime.timedelta(days=5)
